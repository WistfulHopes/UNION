...
#include "MasterDataGetMasterDataResponse_MstFestaRoundRewardData.generated.h"

USTRUCT(BlueprintType)
struct FMasterDataGetMasterDataResponse_MstFestaRoundRewardData {
    GENERATED_BODY()
public:
    ...
    UNIONSYSTEM_API FMasterDataGetMasterDataResponse_MstFestaRoundRewardData();
};
