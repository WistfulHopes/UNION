#include "ItemYellowDrillObject.h"

AItemYellowDrillObject::AItemYellowDrillObject(const FObjectInitializer& ObjectInitializer) : Super(ObjectInitializer) {
    ...
    this->m_DecelerationSeconds = 1.00f;
}
