...
const UECodeGen_Private::FWeakObjectPropertyParams Z_Construct_UClass_UHoudiniParameterOperatorPath_Statics::NewProp_HoudiniInput = { "HoudiniInput", nullptr, (EPropertyFlags)0x0014000000000005, UECodeGen_Private::EPropertyGenFlags::WeakObject, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, STRUCT_OFFSET(UHoudiniParameterOperatorPath, HoudiniInput), Z_Construct_UClass_UHoudiniInput_NoRegister, METADATA_PARAMS(UE_ARRAY_COUNT(NewProp_HoudiniInput_MetaData), NewProp_HoudiniInput_MetaData) };
...
// Begin Registration
struct Z_CompiledInDeferFile_FID_UNION_Plugins_Runtime_HoudiniEngine_Source_HoudiniEngineRuntime_Public_HoudiniParameterOperatorPath_h_Statics
{
	static constexpr FClassRegisterCompiledInInfo ClassInfo[] = {
		{ Z_Construct_UClass_UHoudiniParameterOperatorPath, UHoudiniParameterOperatorPath::StaticClass, TEXT("UHoudiniParameterOperatorPath"), &Z_Registration_Info_UClass_UHoudiniParameterOperatorPath, CONSTRUCT_RELOAD_VERSION_INFO(FClassReloadVersionInfo, sizeof(UHoudiniParameterOperatorPath), 2356725751U) },
	};
};
static FRegisterCompiledInInfo Z_CompiledInDeferFile_FID_UNION_Plugins_Runtime_HoudiniEngine_Source_HoudiniEngineRuntime_Public_HoudiniParameterOperatorPath_h_1710780192(TEXT("/Script/HoudiniEngineRuntime"),
	Z_CompiledInDeferFile_FID_UNION_Plugins_Runtime_HoudiniEngine_Source_HoudiniEngineRuntime_Public_HoudiniParameterOperatorPath_h_Statics::ClassInfo, UE_ARRAY_COUNT(Z_CompiledInDeferFile_FID_UNION_Plugins_Runtime_HoudiniEngine_Source_HoudiniEngineRuntime_Public_HoudiniParameterOperatorPath_h_Statics::ClassInfo),
	nullptr, 0,
	nullptr, 0);
// End Registration
