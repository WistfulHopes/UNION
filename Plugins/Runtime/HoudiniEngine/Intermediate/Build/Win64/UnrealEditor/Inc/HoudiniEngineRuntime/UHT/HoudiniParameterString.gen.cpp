...
const UECodeGen_Private::FArrayPropertyParams Z_Construct_UClass_UHoudiniParameterString_Statics::NewProp_Values = { "Values", nullptr, (EPropertyFlags)0x0020080000000005, UECodeGen_Private::EPropertyGenFlags::Array, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, STRUCT_OFFSET(UHoudiniParameterString, Values), EArrayPropertyFlags::None, METADATA_PARAMS(UE_ARRAY_COUNT(NewProp_Values_MetaData), NewProp_Values_MetaData) };
...
const UECodeGen_Private::FArrayPropertyParams Z_Construct_UClass_UHoudiniParameterString_Statics::NewProp_ChosenAssets = { "ChosenAssets", nullptr, (EPropertyFlags)0x0020080000000005, UECodeGen_Private::EPropertyGenFlags::Array, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, STRUCT_OFFSET(UHoudiniParameterString, ChosenAssets), EArrayPropertyFlags::None, METADATA_PARAMS(UE_ARRAY_COUNT(NewProp_ChosenAssets_MetaData), NewProp_ChosenAssets_MetaData) };
...
const UECodeGen_Private::FBoolPropertyParams Z_Construct_UClass_UHoudiniParameterString_Statics::NewProp_bIsAssetRef = { "bIsAssetRef", nullptr, (EPropertyFlags)0x0020080000000005, UECodeGen_Private::EPropertyGenFlags::Bool | UECodeGen_Private::EPropertyGenFlags::NativeBool, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, sizeof(bool), sizeof(UHoudiniParameterString), &Z_Construct_UClass_UHoudiniParameterString_Statics::NewProp_bIsAssetRef_SetBit, METADATA_PARAMS(UE_ARRAY_COUNT(NewProp_bIsAssetRef_MetaData), NewProp_bIsAssetRef_MetaData) };
...
// Begin Registration
struct Z_CompiledInDeferFile_FID_UNION_Plugins_Runtime_HoudiniEngine_Source_HoudiniEngineRuntime_Public_HoudiniParameterString_h_Statics
{
	static constexpr FClassRegisterCompiledInInfo ClassInfo[] = {
		{ Z_Construct_UClass_UHoudiniParameterString, UHoudiniParameterString::StaticClass, TEXT("UHoudiniParameterString"), &Z_Registration_Info_UClass_UHoudiniParameterString, CONSTRUCT_RELOAD_VERSION_INFO(FClassReloadVersionInfo, sizeof(UHoudiniParameterString), 2541739338U) },
	};
};
static FRegisterCompiledInInfo Z_CompiledInDeferFile_FID_UNION_Plugins_Runtime_HoudiniEngine_Source_HoudiniEngineRuntime_Public_HoudiniParameterString_h_2106492489(TEXT("/Script/HoudiniEngineRuntime"),
	Z_CompiledInDeferFile_FID_UNION_Plugins_Runtime_HoudiniEngine_Source_HoudiniEngineRuntime_Public_HoudiniParameterString_h_Statics::ClassInfo, UE_ARRAY_COUNT(Z_CompiledInDeferFile_FID_UNION_Plugins_Runtime_HoudiniEngine_Source_HoudiniEngineRuntime_Public_HoudiniParameterString_h_Statics::ClassInfo),
	nullptr, 0,
	nullptr, 0);
// End Registration
