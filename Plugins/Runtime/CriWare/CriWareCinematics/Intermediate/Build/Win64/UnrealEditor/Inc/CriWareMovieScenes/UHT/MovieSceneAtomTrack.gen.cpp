...
// Begin Class UMovieSceneAtomTrack
...
struct Z_Construct_UClass_UMovieSceneAtomTrack_Statics
{
	...
	static constexpr UECodeGen_Private::FMetaDataPairParam NewProp_AtomSections_Inner_MetaData[] = {
		{ "AllowPrivateAccess", "TRUE" },
		{ "Category", "MovieSceneAtomTrack" },
		{ "EditInline", "true" },
		{ "ModuleRelativePath", "Public/MovieSceneAtomTrack.h" },
	};
	static constexpr UECodeGen_Private::FMetaDataPairParam NewProp_AtomSections_MetaData[] = {
		{ "AllowPrivateAccess", "TRUE" },
		{ "Category", "MovieSceneAtomTrack" },
		{ "EditInline", "true" },
		{ "ModuleRelativePath", "Public/MovieSceneAtomTrack.h" },
...
const UECodeGen_Private::FObjectPropertyParams Z_Construct_UClass_UMovieSceneAtomTrack_Statics::NewProp_AtomSections_Inner = { "AtomSections", nullptr, (EPropertyFlags)0x0002000000080008, UECodeGen_Private::EPropertyGenFlags::Object, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, 0, Z_Construct_UClass_UMovieSceneSection_NoRegister, METADATA_PARAMS(UE_ARRAY_COUNT(NewProp_AtomSections_Inner_MetaData), NewProp_AtomSections_Inner_MetaData) };
const UECodeGen_Private::FArrayPropertyParams Z_Construct_UClass_UMovieSceneAtomTrack_Statics::NewProp_AtomSections = { "AtomSections", nullptr, (EPropertyFlags)0x004000800000000d, UECodeGen_Private::EPropertyGenFlags::Array, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, STRUCT_OFFSET(UMovieSceneAtomTrack, AtomSections), EArrayPropertyFlags::None, METADATA_PARAMS(UE_ARRAY_COUNT(NewProp_AtomSections_MetaData), NewProp_AtomSections_MetaData) };
...
static_assert(UE_ARRAY_COUNT(Z_Construct_UClass_UMovieSceneAtomTrack_Statics::PropPointers) < 2048);
...
static_assert(UE_ARRAY_COUNT(Z_Construct_UClass_UMovieSceneAtomTrack_Statics::DependentSingletons) < 16);
const UECodeGen_Private::FImplementedInterfaceParams Z_Construct_UClass_UMovieSceneAtomTrack_Statics::InterfaceParams[] = {
	{ Z_Construct_UClass_UMovieSceneTrackTemplateProducer_NoRegister, (int32)VTABLE_OFFSET(UMovieSceneAtomTrack, IMovieSceneTrackTemplateProducer), false },  // 2607263461
};
const UECodeGen_Private::FClassParams Z_Construct_UClass_UMovieSceneAtomTrack_Statics::ClassParams = {
	...
	0x00A800A0u,
	METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UClass_UMovieSceneAtomTrack_Statics::Class_MetaDataParams), Z_Construct_UClass_UMovieSceneAtomTrack_Statics::Class_MetaDataParams)
};
...
// End Class UMovieSceneAtomTrack

// Begin Registration
struct Z_CompiledInDeferFile_FID_UNION_Plugins_Runtime_CriWare_CriWareCinematics_Source_CriWareMovieScenes_Public_MovieSceneAtomTrack_h_Statics
{
	static constexpr FClassRegisterCompiledInInfo ClassInfo[] = {
		{ Z_Construct_UClass_UMovieSceneAtomTrack, UMovieSceneAtomTrack::StaticClass, TEXT("UMovieSceneAtomTrack"), &Z_Registration_Info_UClass_UMovieSceneAtomTrack, CONSTRUCT_RELOAD_VERSION_INFO(FClassReloadVersionInfo, sizeof(UMovieSceneAtomTrack), 2056070321U) },
	};
};
static FRegisterCompiledInInfo Z_CompiledInDeferFile_FID_UNION_Plugins_Runtime_CriWare_CriWareCinematics_Source_CriWareMovieScenes_Public_MovieSceneAtomTrack_h_3654872535(TEXT("/Script/CriWareMovieScenes"),
	Z_CompiledInDeferFile_FID_UNION_Plugins_Runtime_CriWare_CriWareCinematics_Source_CriWareMovieScenes_Public_MovieSceneAtomTrack_h_Statics::ClassInfo, UE_ARRAY_COUNT(Z_CompiledInDeferFile_FID_UNION_Plugins_Runtime_CriWare_CriWareCinematics_Source_CriWareMovieScenes_Public_MovieSceneAtomTrack_h_Statics::ClassInfo),
	nullptr, 0,
	nullptr, 0);
// End Registration
