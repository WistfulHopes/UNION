...
// Begin Class UPlatformManaMovie
...
const UECodeGen_Private::FObjectPropertyParams Z_Construct_UClass_UPlatformManaMovie_Statics::NewProp_ManaMovie = { "ManaMovie", nullptr, (EPropertyFlags)0x0040000000000005, UECodeGen_Private::EPropertyGenFlags::Object, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, STRUCT_OFFSET(UPlatformManaMovie, ManaMovie), Z_Construct_UClass_UManaMovie_NoRegister, METADATA_PARAMS(UE_ARRAY_COUNT(NewProp_ManaMovie_MetaData), NewProp_ManaMovie_MetaData) };
...
static_assert(UE_ARRAY_COUNT(Z_Construct_UClass_UPlatformManaMovie_Statics::PropPointers) < 2048);
...
static_assert(UE_ARRAY_COUNT(Z_Construct_UClass_UPlatformManaMovie_Statics::DependentSingletons) < 16);
const UECodeGen_Private::FClassParams Z_Construct_UClass_UPlatformManaMovie_Statics::ClassParams = {
	...
	0,
	0x001000A0u,
	METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UClass_UPlatformManaMovie_Statics::Class_MetaDataParams), Z_Construct_UClass_UPlatformManaMovie_Statics::Class_MetaDataParams)
};
...
// End Class UPlatformManaMovie

// Begin Registration
struct Z_CompiledInDeferFile_FID_UNION_Plugins_Runtime_CriWare_CriWare_Source_CriWareRuntime_Public_PlatformManaMovie_h_Statics
{
	static constexpr FClassRegisterCompiledInInfo ClassInfo[] = {
		{ Z_Construct_UClass_UPlatformManaMovie, UPlatformManaMovie::StaticClass, TEXT("UPlatformManaMovie"), &Z_Registration_Info_UClass_UPlatformManaMovie, CONSTRUCT_RELOAD_VERSION_INFO(FClassReloadVersionInfo, sizeof(UPlatformManaMovie), 550442833U) },
	};
};
static FRegisterCompiledInInfo Z_CompiledInDeferFile_FID_UNION_Plugins_Runtime_CriWare_CriWare_Source_CriWareRuntime_Public_PlatformManaMovie_h_3713016142(TEXT("/Script/CriWareRuntime"),
	Z_CompiledInDeferFile_FID_UNION_Plugins_Runtime_CriWare_CriWare_Source_CriWareRuntime_Public_PlatformManaMovie_h_Statics::ClassInfo, UE_ARRAY_COUNT(Z_CompiledInDeferFile_FID_UNION_Plugins_Runtime_CriWare_CriWare_Source_CriWareRuntime_Public_PlatformManaMovie_h_Statics::ClassInfo),
	nullptr, 0,
	nullptr, 0);
// End Registration
