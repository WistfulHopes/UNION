...
// Begin Delegate FOnCriWareError
...
const UECodeGen_Private::FStructPropertyParams Z_Construct_UDelegateFunction_UCriWareError_OnCriWareError__DelegateSignature_Statics::NewProp_ErrorInfo = { "ErrorInfo", nullptr, (EPropertyFlags)0x0010000008000182, UECodeGen_Private::EPropertyGenFlags::Struct, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, STRUCT_OFFSET(CriWareError_eventOnCriWareError_Parms, ErrorInfo), Z_Construct_UScriptStruct_FCriWareErrorInfo, METADATA_PARAMS(UE_ARRAY_COUNT(NewProp_ErrorInfo_MetaData), NewProp_ErrorInfo_MetaData) }; // 458462079
...
static_assert(UE_ARRAY_COUNT(Z_Construct_UDelegateFunction_UCriWareError_OnCriWareError__DelegateSignature_Statics::PropPointers) < 2048);
const UECodeGen_Private::FFunctionParams Z_Construct_UDelegateFunction_UCriWareError_OnCriWareError__DelegateSignature_Statics::FuncParams = { (UObject*(*)())Z_Construct_UClass_UCriWareError, nullptr, "OnCriWareError__DelegateSignature", nullptr, nullptr, Z_Construct_UDelegateFunction_UCriWareError_OnCriWareError__DelegateSignature_Statics::PropPointers, UE_ARRAY_COUNT(Z_Construct_UDelegateFunction_UCriWareError_OnCriWareError__DelegateSignature_Statics::PropPointers), sizeof(Z_Construct_UDelegateFunction_UCriWareError_OnCriWareError__DelegateSignature_Statics::CriWareError_eventOnCriWareError_Parms), RF_Public|RF_Transient|RF_MarkAsNative, (EFunctionFlags)0x00530000, 0, 0, METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UDelegateFunction_UCriWareError_OnCriWareError__DelegateSignature_Statics::Function_MetaDataParams), Z_Construct_UDelegateFunction_UCriWareError_OnCriWareError__DelegateSignature_Statics::Function_MetaDataParams) };
static_assert(sizeof(Z_Construct_UDelegateFunction_UCriWareError_OnCriWareError__DelegateSignature_Statics::CriWareError_eventOnCriWareError_Parms) < MAX_uint16);
...
// End Delegate FOnCriWareError

// Begin Class UCriWareError Function GetCriWareError
...
const UECodeGen_Private::FObjectPropertyParams Z_Construct_UFunction_UCriWareError_GetCriWareError_Statics::NewProp_ReturnValue = { "ReturnValue", nullptr, (EPropertyFlags)0x0010000000000580, UECodeGen_Private::EPropertyGenFlags::Object, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, STRUCT_OFFSET(CriWareError_eventGetCriWareError_Parms, ReturnValue), Z_Construct_UClass_UCriWareError_NoRegister, METADATA_PARAMS(0, nullptr) };
...
static_assert(UE_ARRAY_COUNT(Z_Construct_UFunction_UCriWareError_GetCriWareError_Statics::PropPointers) < 2048);
const UECodeGen_Private::FFunctionParams Z_Construct_UFunction_UCriWareError_GetCriWareError_Statics::FuncParams = { (UObject*(*)())Z_Construct_UClass_UCriWareError, nullptr, "GetCriWareError", nullptr, nullptr, Z_Construct_UFunction_UCriWareError_GetCriWareError_Statics::PropPointers, UE_ARRAY_COUNT(Z_Construct_UFunction_UCriWareError_GetCriWareError_Statics::PropPointers), sizeof(Z_Construct_UFunction_UCriWareError_GetCriWareError_Statics::CriWareError_eventGetCriWareError_Parms), RF_Public|RF_Transient|RF_MarkAsNative, (EFunctionFlags)0x14022401, 0, 0, METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UFunction_UCriWareError_GetCriWareError_Statics::Function_MetaDataParams), Z_Construct_UFunction_UCriWareError_GetCriWareError_Statics::Function_MetaDataParams) };
static_assert(sizeof(Z_Construct_UFunction_UCriWareError_GetCriWareError_Statics::CriWareError_eventGetCriWareError_Parms) < MAX_uint16);
...
// End Class UCriWareError Function GetCriWareError

// Begin Class UCriWareError
...
struct Z_Construct_UClass_UCriWareError_Statics
{
	...
	static constexpr UECodeGen_Private::FMetaDataPairParam NewProp_OnCriWareError_MetaData[] = {
	...
	static constexpr FClassFunctionLinkInfo FuncInfo[] = {
		{ &Z_Construct_UFunction_UCriWareError_GetCriWareError, "GetCriWareError" }, // 291776786
		{ &Z_Construct_UDelegateFunction_UCriWareError_OnCriWareError__DelegateSignature, "OnCriWareError__DelegateSignature" }, // 124530255
	};
...
const UECodeGen_Private::FMulticastDelegatePropertyParams Z_Construct_UClass_UCriWareError_Statics::NewProp_OnCriWareError = { "OnCriWareError", nullptr, (EPropertyFlags)0x0010000010080005, UECodeGen_Private::EPropertyGenFlags::InlineMulticastDelegate, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, STRUCT_OFFSET(UCriWareError, OnCriWareError), Z_Construct_UDelegateFunction_UCriWareError_OnCriWareError__DelegateSignature, METADATA_PARAMS(UE_ARRAY_COUNT(NewProp_OnCriWareError_MetaData), NewProp_OnCriWareError_MetaData) }; // 124530255
...
static_assert(UE_ARRAY_COUNT(Z_Construct_UClass_UCriWareError_Statics::PropPointers) < 2048);
UObject* (*const Z_Construct_UClass_UCriWareError_Statics::DependentSingletons[])() = {
	(UObject* (*)())Z_Construct_UClass_UObject,
	(UObject* (*)())Z_Construct_UPackage__Script_CriWareRuntime,
};
static_assert(UE_ARRAY_COUNT(Z_Construct_UClass_UCriWareError_Statics::DependentSingletons) < 16);
const UECodeGen_Private::FClassParams Z_Construct_UClass_UCriWareError_Statics::ClassParams = {
	...
	0,
	0x008800A0u,
	METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UClass_UCriWareError_Statics::Class_MetaDataParams), Z_Construct_UClass_UCriWareError_Statics::Class_MetaDataParams)
};
...
// End Class UCriWareError

// Begin Registration
struct Z_CompiledInDeferFile_FID_UNION_Plugins_Runtime_CriWare_CriWare_Source_CriWareRuntime_Public_CriWareError_h_Statics
{
	static constexpr FClassRegisterCompiledInInfo ClassInfo[] = {
		{ Z_Construct_UClass_UCriWareError, UCriWareError::StaticClass, TEXT("UCriWareError"), &Z_Registration_Info_UClass_UCriWareError, CONSTRUCT_RELOAD_VERSION_INFO(FClassReloadVersionInfo, sizeof(UCriWareError), 1354327108U) },
	};
};
static FRegisterCompiledInInfo Z_CompiledInDeferFile_FID_UNION_Plugins_Runtime_CriWare_CriWare_Source_CriWareRuntime_Public_CriWareError_h_3312401161(TEXT("/Script/CriWareRuntime"),
	Z_CompiledInDeferFile_FID_UNION_Plugins_Runtime_CriWare_CriWare_Source_CriWareRuntime_Public_CriWareError_h_Statics::ClassInfo, UE_ARRAY_COUNT(Z_CompiledInDeferFile_FID_UNION_Plugins_Runtime_CriWare_CriWare_Source_CriWareRuntime_Public_CriWareError_h_Statics::ClassInfo),
	nullptr, 0,
	nullptr, 0);
// End Registration
