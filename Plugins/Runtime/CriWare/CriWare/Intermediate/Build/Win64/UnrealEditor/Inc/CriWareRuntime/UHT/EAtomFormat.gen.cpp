...
const UECodeGen_Private::FEnumParams Z_Construct_UEnum_CriWareRuntime_EAtomFormat_Statics::EnumParams = {
	...
	METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UEnum_CriWareRuntime_EAtomFormat_Statics::Enum_MetaDataParams), Z_Construct_UEnum_CriWareRuntime_EAtomFormat_Statics::Enum_MetaDataParams)
};
...
// End Enum EAtomFormat

// Begin Registration
struct Z_CompiledInDeferFile_FID_UNION_Plugins_Runtime_CriWare_CriWare_Source_CriWareRuntime_Public_EAtomFormat_h_Statics
{
	static constexpr FEnumRegisterCompiledInInfo EnumInfo[] = {
		{ EAtomFormat_StaticEnum, TEXT("EAtomFormat"), &Z_Registration_Info_UEnum_EAtomFormat, CONSTRUCT_RELOAD_VERSION_INFO(FEnumReloadVersionInfo, 2168675015U) },
	};
};
static FRegisterCompiledInInfo Z_CompiledInDeferFile_FID_UNION_Plugins_Runtime_CriWare_CriWare_Source_CriWareRuntime_Public_EAtomFormat_h_305017048(TEXT("/Script/CriWareRuntime"),
	nullptr, 0,
	nullptr, 0,
	Z_CompiledInDeferFile_FID_UNION_Plugins_Runtime_CriWare_CriWare_Source_CriWareRuntime_Public_EAtomFormat_h_Statics::EnumInfo, UE_ARRAY_COUNT(Z_CompiledInDeferFile_FID_UNION_Plugins_Runtime_CriWare_CriWare_Source_CriWareRuntime_Public_EAtomFormat_h_Statics::EnumInfo));
// End Registration
