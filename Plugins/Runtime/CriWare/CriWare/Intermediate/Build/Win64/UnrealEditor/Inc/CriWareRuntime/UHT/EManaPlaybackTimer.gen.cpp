...
const UECodeGen_Private::FEnumParams Z_Construct_UEnum_CriWareRuntime_EManaPlaybackTimer_Statics::EnumParams = {
	...
	METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UEnum_CriWareRuntime_EManaPlaybackTimer_Statics::Enum_MetaDataParams), Z_Construct_UEnum_CriWareRuntime_EManaPlaybackTimer_Statics::Enum_MetaDataParams)
};
...
// End Enum EManaPlaybackTimer

// Begin Registration
struct Z_CompiledInDeferFile_FID_UNION_Plugins_Runtime_CriWare_CriWare_Source_CriWareRuntime_Public_EManaPlaybackTimer_h_Statics
{
	static constexpr FEnumRegisterCompiledInInfo EnumInfo[] = {
		{ EManaPlaybackTimer_StaticEnum, TEXT("EManaPlaybackTimer"), &Z_Registration_Info_UEnum_EManaPlaybackTimer, CONSTRUCT_RELOAD_VERSION_INFO(FEnumReloadVersionInfo, 1950816337U) },
	};
};
static FRegisterCompiledInInfo Z_CompiledInDeferFile_FID_UNION_Plugins_Runtime_CriWare_CriWare_Source_CriWareRuntime_Public_EManaPlaybackTimer_h_279416902(TEXT("/Script/CriWareRuntime"),
	nullptr, 0,
	nullptr, 0,
	Z_CompiledInDeferFile_FID_UNION_Plugins_Runtime_CriWare_CriWare_Source_CriWareRuntime_Public_EManaPlaybackTimer_h_Statics::EnumInfo, UE_ARRAY_COUNT(Z_CompiledInDeferFile_FID_UNION_Plugins_Runtime_CriWare_CriWare_Source_CriWareRuntime_Public_EManaPlaybackTimer_h_Statics::EnumInfo));
// End Registration
