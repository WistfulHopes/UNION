...
// Begin ScriptStruct FBusSendInterpolationSettings
...
struct Z_Construct_UScriptStruct_FBusSendInterpolationSettings_Statics
{
	...
	static constexpr UECodeGen_Private::FMetaDataPairParam NewProp_BusSendLevelForInside_MetaData[] = {
		{ "AllowPrivateAccess", "TRUE" },
		{ "Category", "BusSendInterpolationSettings" },
		{ "ModuleRelativePath", "Public/BusSendInterpolationSettings.h" },
	};
	static constexpr UECodeGen_Private::FMetaDataPairParam NewProp_BusSendLevelForOutside_MetaData[] = {
		{ "AllowPrivateAccess", "TRUE" },
		{ "Category", "BusSendInterpolationSettings" },
		{ "ModuleRelativePath", "Public/BusSendInterpolationSettings.h" },
	};
...
const UECodeGen_Private::FIntPropertyParams Z_Construct_UScriptStruct_FBusSendInterpolationSettings_Statics::NewProp_DspBusSettingsID = { "DspBusSettingsID", nullptr, (EPropertyFlags)0x0010000000000005, UECodeGen_Private::EPropertyGenFlags::Int, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, STRUCT_OFFSET(FBusSendInterpolationSettings, DspBusSettingsID), METADATA_PARAMS(UE_ARRAY_COUNT(NewProp_DspBusSettingsID_MetaData), NewProp_DspBusSettingsID_MetaData) };
const UECodeGen_Private::FStrPropertyParams Z_Construct_UScriptStruct_FBusSendInterpolationSettings_Statics::NewProp_DspBusSettingsName = { "DspBusSettingsName", nullptr, (EPropertyFlags)0x0010000000000005, UECodeGen_Private::EPropertyGenFlags::Str, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, STRUCT_OFFSET(FBusSendInterpolationSettings, DspBusSettingsName), METADATA_PARAMS(UE_ARRAY_COUNT(NewProp_DspBusSettingsName_MetaData), NewProp_DspBusSettingsName_MetaData) };
const UECodeGen_Private::FIntPropertyParams Z_Construct_UScriptStruct_FBusSendInterpolationSettings_Statics::NewProp_BusId = { "BusId", nullptr, (EPropertyFlags)0x0010000000000005, UECodeGen_Private::EPropertyGenFlags::Int, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, STRUCT_OFFSET(FBusSendInterpolationSettings, BusId), METADATA_PARAMS(UE_ARRAY_COUNT(NewProp_BusId_MetaData), NewProp_BusId_MetaData) };
const UECodeGen_Private::FStrPropertyParams Z_Construct_UScriptStruct_FBusSendInterpolationSettings_Statics::NewProp_BusName = { "BusName", nullptr, (EPropertyFlags)0x0010000000000005, UECodeGen_Private::EPropertyGenFlags::Str, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, STRUCT_OFFSET(FBusSendInterpolationSettings, BusName), METADATA_PARAMS(UE_ARRAY_COUNT(NewProp_BusName_MetaData), NewProp_BusName_MetaData) };
const UECodeGen_Private::FFloatPropertyParams Z_Construct_UScriptStruct_FBusSendInterpolationSettings_Statics::NewProp_BusSendLevelForInside = { "BusSendLevelForInside", nullptr, (EPropertyFlags)0x0010000000000005, UECodeGen_Private::EPropertyGenFlags::Float, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, STRUCT_OFFSET(FBusSendInterpolationSettings, BusSendLevelForInside), METADATA_PARAMS(UE_ARRAY_COUNT(NewProp_BusSendLevelForInside_MetaData), NewProp_BusSendLevelForInside_MetaData) };
const UECodeGen_Private::FFloatPropertyParams Z_Construct_UScriptStruct_FBusSendInterpolationSettings_Statics::NewProp_BusSendLevelForOutside = { "BusSendLevelForOutside", nullptr, (EPropertyFlags)0x0010000000000005, UECodeGen_Private::EPropertyGenFlags::Float, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, STRUCT_OFFSET(FBusSendInterpolationSettings, BusSendLevelForOutside), METADATA_PARAMS(UE_ARRAY_COUNT(NewProp_BusSendLevelForOutside_MetaData), NewProp_BusSendLevelForOutside_MetaData) };
const UECodeGen_Private::FFloatPropertyParams Z_Construct_UScriptStruct_FBusSendInterpolationSettings_Statics::NewProp_Width = { "Width", nullptr, (EPropertyFlags)0x0010000000000005, UECodeGen_Private::EPropertyGenFlags::Float, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, STRUCT_OFFSET(FBusSendInterpolationSettings, Width), METADATA_PARAMS(UE_ARRAY_COUNT(NewProp_Width_MetaData), NewProp_Width_MetaData) };
...
static_assert(UE_ARRAY_COUNT(Z_Construct_UScriptStruct_FBusSendInterpolationSettings_Statics::PropPointers) < 2048);
const UECodeGen_Private::FStructParams Z_Construct_UScriptStruct_FBusSendInterpolationSettings_Statics::StructParams = {
	...
	METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UScriptStruct_FBusSendInterpolationSettings_Statics::Struct_MetaDataParams), Z_Construct_UScriptStruct_FBusSendInterpolationSettings_Statics::Struct_MetaDataParams)
};
UScriptStruct* Z_Construct_UScriptStruct_FBusSendInterpolationSettings()
{
	...
	{
		UECodeGen_Private::ConstructUScriptStruct(Z_Registration_Info_UScriptStruct_BusSendInterpolationSettings.InnerSingleton, Z_Construct_UScriptStruct_FBusSendInterpolationSettings_Statics::StructParams);
	}
	return Z_Registration_Info_UScriptStruct_BusSendInterpolationSettings.InnerSingleton;
}
// End ScriptStruct FBusSendInterpolationSettings

// Begin Registration
struct Z_CompiledInDeferFile_FID_UNION_Plugins_Runtime_CriWare_CriWare_Source_CriWareRuntime_Public_BusSendInterpolationSettings_h_Statics
{
...
static FRegisterCompiledInInfo Z_CompiledInDeferFile_FID_UNION_Plugins_Runtime_CriWare_CriWare_Source_CriWareRuntime_Public_BusSendInterpolationSettings_h_1571979718(TEXT("/Script/CriWareRuntime"),
	nullptr, 0,
	Z_CompiledInDeferFile_FID_UNION_Plugins_Runtime_CriWare_CriWare_Source_CriWareRuntime_Public_BusSendInterpolationSettings_h_Statics::ScriptStructInfo, UE_ARRAY_COUNT(Z_CompiledInDeferFile_FID_UNION_Plugins_Runtime_CriWare_CriWare_Source_CriWareRuntime_Public_BusSendInterpolationSettings_h_Statics::ScriptStructInfo),
	nullptr, 0);
// End Registration
