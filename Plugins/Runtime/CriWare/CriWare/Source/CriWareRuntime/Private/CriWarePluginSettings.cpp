...
UCriWarePluginSettings::UCriWarePluginSettings() {
    ...
    this->ContentDir = TEXT("CriWareData");
    this->NumBinders = 16;
    this->MaxBinds = 128;
    this->NumLoaders = 16;
    this->MaxFiles = 0;
    ...
    this->AwbRoot = TEXT("01_Union/CriWareData");
    this->MonitorCommunicationBufferSize = 2097152;
    this->MaxPitch = 2400;
    this->AsrOutputChannels = 6;
    this->MaxVirtualVoices = 256;
    this->NumStandardMemoryVoices = 256;
    ...
    this->UseSonicSYNC = true;
    this->EnableDualSenseOnWindows = false;
    ...
    this->PS5_MaxChannelPorts = 8;
    this->PS5_MaxObjectPorts = 0;
